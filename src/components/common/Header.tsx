    ...
    <div>
      <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
          {/* Logo and Links grouped together */}
          <div className="flex items-center space-x-28">
            {/* Logo */}
            <h1 className="text-2xl font-bold text-[#ce6968]">
          ...
          {/* Start Writing Button & Mobile Toggle */}
          <div className="flex items-center space-x-3">
            <Link to={"/create"}><FiEdit className="text-xl sm:text-2xl cursor-pointer" /></Link>
            <Link to={"/create"}>
            <span className="hidden sm:flex sm:text-xl font-semibold cursor-pointer">
              Start Writing
            </span>
            </Link>
            <Link to={"/profile"}>
            ...
            <button onClick={toggleNavbarMenu} className="md:hidden">
              {isOpen ? (
